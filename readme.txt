...
Разделю этот гайд на 2 части ( собственно сама апишка(самая простая из всех наверно) и сам код луа(получился небольшой). Дело в том , что у доты нет своих вебсокетов для каждой кастомной игры, приходится вручную каждую секунду отправлять запрос на свою апи, лично я в гайде буду использовать OpenServer(локальный хостинг) , всем рекомендую , потом перейдете на хост за 10 рублей в год и вам хватать будет.
